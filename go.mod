...
require (
	...
	github.com/nomad-software/vend v1.0.3
...
require (
	...
	github.com/Clever/wag/clientconfig/v9 v9.0.0-20230227191614-7aa97ba44ab1 // indirect
...
require (
	github.com/Clever/breakdown/gen-go/client v0.1.0
